const curriculum = [
  ...
  {
    id: 'minimal',
    title: '헷갈리는 소리 게임 (8문제)',
    lessons: [
      { id: 9, sentence: '라면 말고 나면이라고 말해요.', focus: 'ㄹ↔ㄴ', tip: '라/나를 번갈아 천천히 말해요.' },
      { id: 10, sentence: '사자와 파자를 구분해요.', focus: 'ㅅ↔ㅍ', tip: 'ㅅ은 바람 가늘게, ㅍ은 입술 폭발.' },
      { id: 11, sentence: '자리와 차리를 또렷하게 구분해요.', focus: 'ㅈ↔ㅊ', tip: 'ㅊ은 더 강한 숨, ㅈ은 부드러운 시작.' },
      { id: 12, sentence: '가위와 카드를 또박또박 읽어요.', focus: 'ㄱ↔ㅋ', tip: 'ㅋ은 숨을 강하게 내보내요.' },
      { id: 13, sentence: '달과 탈을 정확히 말해요.', focus: 'ㄷ↔ㅌ', tip: 'ㅌ에서 혀를 더 세게 튕겨요.' },
      { id: 14, sentence: '볼과 폴을 번갈아 말해요.', focus: 'ㅂ↔ㅍ', tip: 'ㅂ은 약하게, ㅍ은 강하게 터뜨려요.' },
      { id: 15, sentence: '술과 줄을 구분해서 읽어요.', focus: 'ㅅ↔ㅈ', tip: 'ㅅ은 마찰, ㅈ은 짧은 파찰.' },
      { id: 16, sentence: '라라 나나 게임을 해요.', focus: 'ㄹ↔ㄴ', tip: '혀 위치를 느끼며 번갈아 말해요.' },
    ],
  },
  {
    id: 'words',
    title: '단어·문장 연결 (8문제)',
    lessons: [
      { id: 17, sentence: '오늘은 날씨가 맑아요.', focus: '리듬 말하기', tip: '단어를 끊어서 또박또박.' },
      { id: 18, sentence: '학교에서 친구와 놀았어요.', focus: '리듬 말하기', tip: '빨리 말하지 않고 박자 맞추기.' },
      { id: 19, sentence: '우리는 놀이터에서 달리기를 해요.', focus: 'ㄹ', tip: 'ㄹ이 들어간 단어를 크게 강조해요.' },
      { id: 20, sentence: '선생님이 새싹 소식을 알려줘요.', focus: 'ㅅ', tip: 'ㅅ이 있는 낱말마다 바람 소리 의식하기.' },
      { id: 21, sentence: '바쁜 아빠가 파란 풍선을 샀어요.', focus: 'ㅂ/ㅍ', tip: '유성/무성 느낌을 비교하며 읽어요.' },
      { id: 22, sentence: '나무 아래 노란 나비가 날아요.', focus: 'ㄴ', tip: '코 울림을 유지하며 문장 길게 읽기.' },
      { id: 23, sentence: '쌀쌀한 아침에도 씩씩하게 산책해요.', focus: '된소리·마찰음', tip: '쌍자음은 더 단단하게 시작해요.' },
      { id: 24, sentence: '차가운 주스를 천천히 마셔요.', focus: 'ㅈ/ㅊ', tip: 'ㅊ에서 바람을 더 세게 보내요.' },
    ],
  },
  {
    id: 'final',
    title: '받침·이중받침 마스터 (8문제)',
    lessons: [
      { id: 25, sentence: '앉고 읽고 넓게 웃어요.', focus: 'ㄵ/ㄺ/ㄼ', tip: '받침은 짧게, 다음 음절은 분명하게.' },
      { id: 26, sentence: '삶과 값도 또박또박 읽어요.', focus: 'ㄻ/ㅄ', tip: '입모양을 크게 하고 천천히.' },
      { id: 27, sentence: '꽃밭 옆에서 젊은 형이 책을 읽어요.', focus: '받침(ㅊ/ㄺ/ㄻ)', tip: '받침 발음 후 다음 소리로 바로 이어요.' },
      { id: 28, sentence: '닭과 곶감 값을 같이 적어요.', focus: '받침(ㄺ/ㅄ)', tip: '받침을 길게 끌지 말고 짧게 처리해요.' },
      { id: 29, sentence: '넓은 숲길을 같이 걸어요.', focus: '받침(ㄼ/ㅄ)', tip: '복합받침에서 대표음만 또렷하게.' },
      { id: 30, sentence: '읽는 법을 알고 밝게 웃어요.', focus: '받침(ㄺ/ㄺ)', tip: '읽-는처럼 음절 경계를 의식해요.' },
      { id: 31, sentence: '앉는 자세를 바르게 배워요.', focus: '받침(ㄵ)', tip: '앉-는 연결에서 혀 위치를 유지해요.' },
      { id: 32, sentence: '값있는 책을 들고 집에 가요.', focus: '받침(ㅄ)', tip: '값-있는 연결을 천천히 나눠 읽어요.' },
    ],
  },
];
...
const researchInsights = [
  {
    ...
    action: '한 파트 8문제 + 최소대립쌍 반복 + 미션형 학습',
  },
  {
    title: '늦게 안정되는 소리 집중',
    detail:
